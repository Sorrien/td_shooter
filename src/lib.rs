...
//! td_shooter is split into many plugins with their own set of responsibilities.
...
/// Main entrypoint for td_shooter.
///
...
///
/// Because td_shooter uses `seldom_fn_plugin`, these are all functions.
